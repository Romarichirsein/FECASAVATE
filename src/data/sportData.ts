...
import { Discipline, PalmaresItem, TimelineEvent, HeroFigure, BlogArticle, Member, FightCardMatch, Product, AppNotification, GradeRecipient, OfficialExpert, WPMember } from '../types';
...
/**
 * Annuaire des membres licenciés FECASAVATE
 * Données extraites de la base WordPress officielle (fecasavate.cm)
 */
export const membresWP: WPMember[] = [
  {
    id: 'wp-1',
    firstName: 'Fabrice',
    lastName: 'NGALIEU',
    ...
    tournoi: 4,
    medailles: 2,
    presentation: 'kkhsgfjvjlkjliorvj',
    birth_date: '1989/11/11',
    mobile: '659247922',
    email: 'fydy.cm@gmail.com',
  ...
  },
  {
    ...
    tournoi: 5,
    medailles: 5,
    presentation: 'Jeune athlète 5 fois championne du tournoi de Douala',
    birth_date: '2022/06/15',
    mobile: '696013492',
    email: 'ebenpatricia@yahoo.com',
    facebook: 'https://facebook.com/#',
    instagram: 'https://instagram.com/#',
    youtube: 'https://youtube.com/#',
    imageUrl: '',
  ...
  },
  {
    ...
    tournoi: 12,
    medailles: 9,
    presentation: 'Je m’appelle Maxime Plaisir Mbile, j’ai 24 ans, je suis sportif (tireur) de la Fédération camerounaise de savate. J’ai toujours été passionné par les sports de combats, alors après quelques années d\'études, j\'ai décidé de faire carrière dans les sports de combats (Savate, Kick-boxing, boxes Anglais.)rnrn     Ayant 8 années d\'expérience, j\'ai participé plusieurs fois à des championnats Nationaux et d\'Afrique.rnrn      En ce moment, je souhaiterais aller plus loin et de ce fait intégrer dans une association Professionnelle qui présente plus de perspectives d’évolution et de Compétition internationale.',
    birth_date: '1998/02/21',
    mobile: '690719412',
    email: 'maxplaisir1437@yahoo.com',
    facebook: 'https://facebook.com/Max Banning',
    instagram: '',
    youtube: '',
  ...
  },
  {
    ...
    tournoi: 25,
    medailles: 8,
    presentation: 'La Fecasavate :  rêve africain de la savate',
    birth_date: '',
    mobile: '670040690',
    email: 'mandengbakadal@gmail.com',
    facebook: 'https://facebook.com/#',
    instagram: 'https://instagram.com/#',
    youtube: 'https://youtube.com/#',
    imageUrl: '',
  ...
  },
  {
    ...
    birth_date: '',
    mobile: '',
    email: 'deloria@galaxygrove.site',
    facebook: '',
    instagram: '',
    youtube: '',
    imageUrl: '',
  ...
  },
  {
    ...
    birth_date: '',
    mobile: '',
    email: 'lylebuttrose@1secmail.net',
    facebook: '',
    instagram: '',
    youtube: '',
    imageUrl: '',
  ...
  },
  {
    ...
    birth_date: '',
    mobile: '',
    email: 'maragaret@galaxygrove.site',
    facebook: '',
    instagram: '',
    youtube: '',
    imageUrl: '',
  ...
  },
  {
    ...
    birth_date: '',
    mobile: '',
    email: 'albertnickerburger@gmail.com',
    facebook: '',
    instagram: '',
    youtube: '',
    imageUrl: '/images/members/member_28_profile.gif',
    grade: 'Gant Rouge',
  },
  {
    id: 'wp-29',
    ...
    birth_date: '',
    mobile: '',
    email: 'markthomas1181ox7u@gsasearchengineranker.com',
    facebook: '',
    instagram: '',
    youtube: '',
    imageUrl: '',
  ...
  },
  {
    ...
    birth_date: '',
    mobile: '',
    email: 'rosaal-rashid38098@seoautomationpro.com',
    facebook: '',
    instagram: '',
    youtube: '',
    imageUrl: '',
  ...
  },
  {
    ...
    birth_date: '',
    mobile: '',
    email: 'danaruggiero@biznesonlajn360.store',
    facebook: '',
    instagram: '',
    youtube: '',
    imageUrl: '',
  ...
  },
  {
    ...
    birth_date: '',
    mobile: '',
    email: 'merrypeeler@xdderetronline.xyz',
    facebook: '',
    instagram: '',
    youtube: '',
    imageUrl: '',
  ...
  },
  {
    ...
    tournoi: 30,
    medailles: 15,
    presentation: "Champion du Monde Vétéran Savate. 4x Champion de France & Champion d'Europe Lutte Contact.",
    birth_date: '1978/05/12',
    mobile: '699112233',
    email: 'evina.patrick@fecasavate.cm',
    facebook: 'https://facebook.com/#',
    instagram: 'https://instagram.com/#',
    youtube: 'https://youtube.com/#',
    imageUrl: '/images/patrick_evina.jpeg',
  ...
  },
  {
    ...
    medailles: 3,
    specialty: 'Savate Combat',
    presentation: 'Récipiendaire Gant Rouge 3ème degré - Passage de Grade Officiel du 12 Juillet 2026.',
    birth_date: '1995/08/20',
    mobile: '695443322',
    email: 'nyemeck.miguel@fecasavate.cm',
    facebook: 'https://facebook.com/#',
    instagram: 'https://instagram.com/#',
    youtube: 'https://youtube.com/#',
    imageUrl: '/images/nyemeck_ngassa.jpeg',
  ...
  },
  {
    ...
    medailles: 2,
    specialty: 'Savate Assaut & Combat',
    presentation: 'Récipiendaire Gant Vert 1er degré - Passage de Grade Officiel du 12 Juillet 2026.',
    birth_date: '1997/03/15',
    mobile: '694556677',
    email: 'mandeng.youmbi@fecasavate.cm',
    facebook: 'https://facebook.com/#',
    instagram: 'https://instagram.com/#',
    youtube: 'https://youtube.com/#',
    imageUrl: '/images/mandeng_youmbi.jpeg',
  ...
  },
  {
    ...
    mobile: '693445566',
    email: 'mfegue.christian@fecasavate.cm',
    facebook: 'https://facebook.com/#',
    instagram: 'https://instagram.com/#',
    youtube: 'https://youtube.com/#',
    imageUrl: '/images/mfegue_ndjessa.jpeg',
  ...
  },
  {
    ...
    medailles: 3,
    specialty: 'Savate Assaut',
    presentation: 'Récipiendaire Gant Bleu 1er degré - Passage de Grade Officiel du 12 Juillet 2026.',
    birth_date: '1996/02/10',
    mobile: '692334455',
    email: 'noe.mandeng@fecasavate.cm',
    facebook: 'https://facebook.com/#',
    instagram: 'https://instagram.com/#',
    youtube: 'https://youtube.com/#',
    imageUrl: '/images/mandeng_noe.jpeg',
  ...
  },
  {
    ...
    birth_date: '1996/02/10',
    mobile: '691223344',
    email: 'david.mandeng@fecasavate.cm',
    facebook: 'https://facebook.com/#',
    instagram: 'https://instagram.com/#',
    youtube: 'https://youtube.com/#',
    imageUrl: '/images/mandeng_david.jpeg',
  ...
  },
  {
    ...
    medailles: 1,
    specialty: 'Savate Assaut',
    presentation: 'Récipiendaire Gant Jaune - Passage de Grade Officiel du 12 Juillet 2026.',
    birth_date: '1999/07/22',
    mobile: '690112233',
    email: 'tella.bertrand@fecasavate.cm',
    facebook: 'https://facebook.com/#',
    instagram: 'https://instagram.com/#',
    youtube: 'https://youtube.com/#',
    imageUrl: '/images/tella_faha.jpeg',
  ...
  },
  {
    ...
    mobile: '689001122',
    email: 'fotsine.emmanuel@fecasavate.cm',
    facebook: 'https://facebook.com/#',
    instagram: 'https://instagram.com/#',
    youtube: 'https://youtube.com/#',
    imageUrl: '/images/fotsine_fogang.jpeg',
  ...
  },
  {
    ...
    mobile: '688990011',
    email: 'ndzie.elisabeth@fecasavate.cm',
    facebook: 'https://facebook.com/#',
    instagram: 'https://instagram.com/#',
    youtube: 'https://youtube.com/#',
    imageUrl: '/images/ndzie_bomba.jpeg',
  ...
  },
  {
    ...
    mobile: '687889900',
    email: 'ayissi.bessala@fecasavate.cm',
    facebook: 'https://facebook.com/#',
    instagram: 'https://instagram.com/#',
    youtube: 'https://youtube.com/#',
    imageUrl: '/images/ayissi_bessala.jpeg',
  ...
  },
  {
    ...
    mobile: '686778899',
    email: 'nouaghue.jean@fecasavate.cm',
    facebook: 'https://facebook.com/#',
    instagram: 'https://instagram.com/#',
    youtube: 'https://youtube.com/#',
    imageUrl: '/images/nouaghue_koagne.jpeg',
