...
export const membresWP: WPMember[] = [
  ...
  },
  {
    ...
    tournoi: 25,
    medailles: 8,
    specialty: 'Administration Fédérale & Savate Assaut',
    presentation: 'Président actuel de la Fédération, œuvrant pour le rayonnement de la Boxe Française au Cameroun.',
    imageUrl: '',
    grade: 'Officiel Fédéral',
  },
  {
  ...
  // Champions officiels (récipiendaires du passage de grade du 12 Juillet 2026)
  {
    id: 'wp-evina',
    firstName: 'Patrick Timbert',
    lastName: 'EVINA',
  ...
  // Champions de renommée internationale
  {
    id: 'wp-pharelle',
    firstName: 'Akouan',
    lastName: 'PHARELLE',
    ...
    medailles: 20,
    specialty: 'Savate Combat & Pro',
    presentation: 'Champion du Monde Combat 2018 (Chine). Champion du Monde Pro 2023 (Bulgarie). Directeur Technique National.',
    imageUrl: '',
    grade: "Gant d'Argent",
  },
  {
    ...
    tournoi: 35,
    medailles: 18,
    specialty: 'Savate Assaut & Combat Féminin',
    presentation: 'Vice-Championne du Monde 2022 (Italie) & 2023 (France). Référence du sport féminin camerounais.',
    imageUrl: '',
    grade: "Gant d'Argent",
  },
  {
    ...
    medailles: 10,
    specialty: 'Savate Assaut Féminin',
    presentation: 'Médaille de Bronze aux Championnats du Monde 2022 (Italie).',
    imageUrl: '',
    grade: 'Gant Vert',
  },
  {
    ...
    medailles: 14,
    specialty: 'Savate Assaut',
    presentation: 'Champion du Monde Savate Assaut 2016 (Rome, Italie) - Poids Moyens.',
    imageUrl: '',
    grade: "Gant d'Argent",
  },
];
