    ...
    <div className="space-y-12 pb-16 font-sans relative">
      ...
      <section className="relative w-full h-[50vh] min-h-[320px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          ...
          >
            {language === 'fr' ? 'Licences & Affiliations' : 'Licenses & Affiliations'}
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            {language === 'fr'
              ? 'Soumettez vos demandes de licences professionnelles et affiliations de club pour homologation nationale.'
              : 'Submit your professional licensing dossiers and club affiliation applications for national accreditation.'}
          </motion.p>
        </div>
      </section>

      <div className="px-4 sm:px-8 max-w-[1700px] w-full mx-auto space-y-12 relative">
